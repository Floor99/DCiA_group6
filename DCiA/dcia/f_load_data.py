...
def load_data(att_table,adjency_list_df):
    ...
    edge_df=adjency_list_df.drop_duplicates(keep="first").reset_index(drop=True)
    ...
    #checks if this is the correct att table
    if not attribute_csv1.empty:
    ...
    #checks if this is the correct att table
    if not attribute_csv_empty.empty:
    ...
    return attribute_csv_empty, attribute_csv1
